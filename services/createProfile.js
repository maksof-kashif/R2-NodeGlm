...
function createCustomerProfile(data,callback) {
	...
	creditCard.setCardNumber(data.card.cardNum);
	creditCard.setExpirationDate(data.card.expire);
	...
	customerAddress.setPhoneNumber(data.number);
    customerAddress.setCompany(data.organization)
